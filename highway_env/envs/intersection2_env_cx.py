...
class IntersectionEnvCX2(AbstractEnv):
    ...
    def _make_vehicles(self, n_vehicles: int = 10) -> None:
        ...
        # Challenger vehicle
        self._spawn_vehicle(10, spawn_probability=1, go_straight=False, position_deviation=0.0, speed_deviation=0.2)
...
class MultiAgentIntersectionEnv(IntersectionEnvCX2):
    @classmethod
    def default_config(cls) -> dict:
        config = super().default_config()
        config.update({
...
class ContinuousIntersectionEnv(IntersectionEnvCX2):
    @classmethod
    def default_config(cls) -> dict:
        config = super().default_config()
        config.update({
